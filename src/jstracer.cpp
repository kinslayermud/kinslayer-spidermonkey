...
static jsdouble FASTCALL
fmul2(jsdouble x, jsdouble y)
{
    return x * y;
}
JS_DEFINE_CALLINFO_2(static, DOUBLE, fmul2, DOUBLE, DOUBLE, 1, 1)

static jsdouble FASTCALL
fadd2(jsdouble x, jsdouble y)
{
    return x + y;
}
JS_DEFINE_CALLINFO_2(static, DOUBLE, fadd2, DOUBLE, DOUBLE, 1, 1)

static jsdouble FASTCALL
fdiv2(jsdouble x, jsdouble y)
{
    return x / y;
}
JS_DEFINE_CALLINFO_2(static, DOUBLE, fdiv2, DOUBLE, DOUBLE, 1, 1)

static jsdouble FASTCALL
fsub2(jsdouble x, jsdouble y)
{
    return x - y;
}
JS_DEFINE_CALLINFO_2(static, DOUBLE, fsub2, DOUBLE, DOUBLE, 1, 1)
...
public:
    ...
    LIns *ins2(LOpcode op, LIns *a, LIns *b) {
        switch (op) {
        case LIR_fadd:
            return fcall2(&fadd2_ci, a, b);
        case LIR_fsub:
            return fcall2(&fsub2_ci, a, b);
        case LIR_fmul:
            return fcall2(&fmul2_ci, a, b);
        case LIR_fdiv:
            return fcall2(&fdiv2_ci, a, b);
        case LIR_feq:
